package com.example.grpublisher.controller;

import com.example.grpublisher.model.Group;
import com.example.grpublisher.model.Message;
import com.example.grpublisher.service.GroupService;
import com.example.grpublisher.service.MessagingService;
...
public class PublishController {
    ...
    public void sendMsgToGroup(@PathVariable("appId") String appId,
        ...
        members.parallelStream()
                .forEach( e -> {
                    msgSrv.publishMessage(appId, e, msgStr);
         });
    }
